...
from .views import EquipmentsListView, EquipmentsDetailView, EquipmentsUpdateView, EquipmentsCreateView, DeleteEquipmentsView, connect_equipments, disconnect_equipments
